...
class WchatyAPI {
  ...
  async contactsGet (mqttProxy: MqttProxy, bot: Wechaty) {
  ...
  async roomsGet (mqttProxy: MqttProxy, bot: Wechaty) {
  ...
  async send (params: any, bot: Wechaty): Promise<any> {
  ...
  async sendAt (params: any, bot: Wechaty) {
  ...
  async createRoom (params: any, bot: Wechaty) {
  ...
  async getQrcod (params: any, bot: Wechaty, mqttProxy: MqttProxy) {
