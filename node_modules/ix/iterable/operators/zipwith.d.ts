 ...
 */
export declare function zipWith<T, T2>(source2: Iterable<T2>): OperatorFunction<T, [T, T2]>;
/**
 * Merges multiple iterable sequences into one iterable sequence by combining their elements in a pairwise fashion.
 *
 * @template T The type of the first async-iterable sequence.
 ...
 */
export declare function zipWith<T, T2, T3>(source2: Iterable<T2>, source3: Iterable<T3>): OperatorFunction<T, [T, T2, T3]>;
/**
 * Merges multiple iterable sequences into one iterable sequence by combining their elements in a pairwise fashion.
 *
 * @template T The type of the first async-iterable sequence.
 ...
 */
export declare function zipWith<T, T2, T3, T4>(source2: Iterable<T2>, source3: Iterable<T3>, source4: Iterable<T4>): OperatorFunction<T, [T, T2, T3, T4]>;
/**
 * Merges multiple iterable sequences into one iterable sequence by combining their elements in a pairwise fashion.
 *
 * @template T The type of the first async-iterable sequence.
 ...
 */
export declare function zipWith<T, T2, T3, T4, T5>(source2: Iterable<T2>, source3: Iterable<T3>, source4: Iterable<T4>, source5: Iterable<T5>): OperatorFunction<T, [T, T2, T3, T4, T5]>;
/**
 * Merges multiple iterable sequences into one iterable sequence by combining their elements in a pairwise fashion.
 *
 * @template T The type of the first async-iterable sequence.
 ...
 * sequences in a pairwise fashion.
 */
export declare function zipWith<T, T2, T3, T4, T5, T6>(source2: Iterable<T2>, source3: Iterable<T3>, source4: Iterable<T4>, source5: Iterable<T5>, source6: Iterable<T6>): OperatorFunction<T, [T, T2, T3, T4, T5, T6]>;
/**
 * Merges multiple iterable sequences into one iterable sequence by combining their elements in a pairwise fashion.
 *
 ...
 */
export declare function zipWith<T>(...sources: Iterable<T>[]): OperatorFunction<T, T[]>;
