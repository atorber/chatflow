...
// 获取聊天记录服务接口
export const ServeCreateTalkRecords = (data:any = []) => {
  return post('/api/v1/talk/records', data)
}

// 获取聊天记录服务接口
export const ServeCreateTalkRecordsUpload = (data: {} | undefined, options = {}) => {
  return post('/api/v1/talk/imageVika', data, options)
}
