...
// 上传头像裁剪图片服务接口
export const ServeUploadImageVika = (data: {} | undefined, options = {}) => {
  console.log(data)
  return upload('/api/v1/upload/imageVika', data, options)
}

// 上传头像裁剪图片服务接口
export const ServeUploadAvatar = (data: {} | undefined) => {
  return post('/api/v1/upload/avatar', data)
}

// 上传头像裁剪图片服务接口
export const ServeUploadImage = (data: {} | undefined) => {
  console.log(data)
